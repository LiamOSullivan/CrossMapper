...
public class InputNode extends Node
{
	...
	int maxInputNs;
	int maxOutputNs;
	float rawInput = 0.0F; float normalisedInput = 0.0F;
	int myType = 0; //type is 0 for OSC node, 1 for Serial
	String typeName;
	boolean normalisation=true; boolean calibrating =false; 
	...
	void display()
	{
		...
		parent.text(normalisedInput, x-(nodeSize/2) , y+(nodeSize/2));
	}
